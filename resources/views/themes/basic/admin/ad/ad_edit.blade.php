                    ...
                    <form action="{{ url('admin/ad/save') }}" role="form" method="post" name="edit_form" id="edit_form" enctype="multipart/form-data">
                        <div class="box-body">
                            ...
                            <div class="form-group required {{ $errors->has('category_id') ? ' has-error' : '' }}">
                                ...
                                @if(isset($c) && !empty($c))
                                <?$cid = Util::getOldOrModelValue('category_id', $ad_detail);?>
                            ...
                            <div id="type_5" class="common_fields_container">
                                ...
                                <div class="form-group required {{ $errors->has('condition_id_type_5') ? ' has-error' : '' }}">
                                    <label for="condition_id_type_5" class="control-label">{{ trans('publish_edit.Condition') }}</label>
                                    @if(!$ac->isEmpty())
                                    <select name="condition_id_type_5" id="condition_id_type_5" class="form-control chosen_select" data-placeholder="{{ trans('publish_edit.Select Condition') }}">
                                        <option value="0"></option>
                                        @foreach ($ac as $k => $v)
                                            @if(Util::getOldOrModelValue('condition_id_type_5', $ad_detail) == $v->ad_condition_id)
                                                <option value="{{ $v->ad_condition_id }}" selected>{{ $v->ad_condition_name }}</option>
                                            @else
                                                <option value="{{ $v->ad_condition_id }}">{{ $v->ad_condition_name }}</option>
                                            @endif
                            ...
                            <div id="type_6" class="common_fields_container">
                                ...
                                <div class="form-group required {{ $errors->has('condition_id_type_6') ? ' has-error' : '' }}">
                                    <label for="condition_id_type_6" class="control-label">{{ trans('publish_edit.Condition') }}</label>
                                    @if(!$ac->isEmpty())
                                    <select name="condition_id_type_6" id="condition_id_type_6" class="form-control chosen_select" data-placeholder="{{ trans('publish_edit.Select Condition') }}">
                                        <option value="0"></option>
                                        @foreach ($ac as $k => $v)
                                            @if(Util::getOldOrModelValue('condition_id_type_6', $ad_detail) == $v->ad_condition_id)
                                                <option value="{{ $v->ad_condition_id }}" selected>{{ $v->ad_condition_name }}</option>
                                            @else
                                                <option value="{{ $v->ad_condition_id }}">{{ $v->ad_condition_name }}</option>
                                            @endif
                            ...
                            <!-- category type 8 services -->
                            <div id="type_8" class="common_fields_container">
                                <div class="form-group required {{ $errors->has('ad_price_type_8') ? ' has-error' : '' }}" style="margin-bottom: 15px;">
                                    <label for="ad_price_type_4" class="control-label">{{ trans('publish_edit.Salary') }}</label>
                                    <div>
                                        <div class="pull-left checkbox"><input type="radio" name="price_radio_type_8" id="price_radio_type_8" value="1" {{ Util::getOldOrModelValue('price_radio_type_8', $ad_detail) == 1 ? 'checked' : '' }}></div>
                                        <div class="pull-left" style="margin-left:5px;">
                                            <div class="input-group">
                                                @if(config('dc.show_price_sign_before_price'))
                                                    <div class="input-group-addon">{{ config('dc.site_price_sign') }}</div>
                                                    <input type="text" class="form-control" id="ad_price_type_8" name="ad_price_type_8" value="{{ Util::getOldOrModelValue('ad_price_type_8', $ad_detail) }}" />
                                                @else
                                                    <input type="text" class="form-control" id="ad_price_type_8" name="ad_price_type_8" value="{{ Util::getOldOrModelValue('ad_price_type_8', $ad_detail) }}" />
                                                    <div class="input-group-addon">{{ config('dc.site_price_sign') }}</div>
                                                @endif
                                        ...
                                        <div>
                                            <label class="radio-inline">
                                                <input type="radio" name="price_radio_type_8" id="price_radio_type_8" value="2" {{ Util::getOldOrModelValue('price_radio_type_8', $ad_detail) == 2 ? 'checked' : '' }}> {{ trans('publish_edit.Negotiable') }}
                                            </label>
                                        </div>
